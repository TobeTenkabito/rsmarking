            ...
            <div class="bg-white w-full max-w-4xl h-[85vh] rounded-3xl shadow-2xl relative overflow-hidden flex flex-col">
                ...
                <div class="p-6 border-b border-slate-100 flex justify-between items-center">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h2 class="text-lg font-black text-slate-800">Python Script Editor</h2>
                            <p class="text-xs text-slate-500">Run custom remote-sensing algorithms in a secure sandbox environment</p>
                        </div>
                    </div>
