    ...
    <div id="ai-window"
        ...
        <div class="flex h-14 shrink-0 items-center justify-between gap-3 border-b border-slate-100 px-4">
            ...
            <div class="flex shrink-0 items-center gap-1.5">
                ...
                <div id="ai-permission-control">
                    <select id="ai-permission-select" aria-label="Agent permission"
        ...
        <div class="relative min-h-0 flex-1 overflow-hidden">
            <div id="ai-agent-panel" class="flex h-full min-h-0 flex-col bg-white">
                <div id="ai-permission-banner"
                    class="shrink-0 border-b border-slate-100 bg-slate-50 px-5 py-2 text-[10px] font-semibold text-slate-500">
                    Standard permission: task-matched changes; deletion must be explicit and specific.
                </div>
            ...
            <div class="flex items-end gap-2 rounded-lg border border-slate-200 bg-white p-2 focus-within:ring-2 focus-within:ring-slate-200">
                <div id="ai-agent-attachment-controls" class="shrink-0">
                    <input id="ai-agent-file-input" type="file" multiple
                        accept="image/png,image/jpeg,image/webp,image/gif,.txt,.md,.markdown,.json,.geojson,.csv,.xml,.log,.py,.js,.ts,.html,.css,.yml,.yaml"
                        class="hidden">
